...
def getData():
    ...
    input_var = { "MonthlyBill": y }
    json_data = json.dumps(input_var)

    return json_data

# df_sol = pd.DataFrame(data=x)
# df_sol.columns= ['Hourly Cost Months 1&2', 'Hourly Cost Months 3&4', 'Hourly Cost Months 5&6', 'Hourly Cost Months 7&8', 'Hourly Cost Months 9&10', 'Hourly CostMonths 11&12']

# df_sol.to_csv("Opt_Base.csv")