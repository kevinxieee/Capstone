...
df_sol = pd.concat([pd.DataFrame(data=pcea_solutions).transpose(), pd.DataFrame(data=esb_solutions).transpose(), pd.DataFrame(data=ddr_solutions).transpose()], axis=1) 
df_sol.columns= ['PCEA Months 1&2', 'PCEA Months 3&4', 'PCEA Months 5&6', 'PCEA Months 7&8', 'PCEA Months 9&10', 'PCEA Months 11&12', \
         'ESB Months 1&2', 'ESB Months 3&4', 'ESB Months 5&6', 'ESB Months 7&8', 'ESB Months 9&10', 'ESB Months 11&12', \
         'DDR Months 1&2', 'DDR Months 3&4', 'DDR Months 5&6', 'DDR Months 7&8', 'DDR Months 9&10', 'DDR Months 11&12']

df_sol.to_csv("Opt_wRev.csv")